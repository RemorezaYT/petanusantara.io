            ...
            <section class="grid-menu">
                ...
                <article class="menu-card peta">
                    <div class="menu-card-inner">
                        <div class="menu-top">
                            <div class="menu-badge"><span class="mini-dot"></span> Interaktif • Merah Putih</div>
                        ...
                        <div class="menu-footer">
                            ...
                            <a href="peta_budaya.php" class="menu-btn">Buka Peta →</a>
                        </div>
                    </div>
                </article>
                ...
                <article class="menu-card info">
                    <div class="menu-card-inner">
                        <div class="menu-top">
                            <div class="menu-badge"><span class="mini-dot"></span> Literasi • Nusantara</div>
                        ...
                        <div class="menu-footer">
                            ...
                            <a href="pemberitahuan.php" class="menu-btn">Buka Pemberitahuan →</a>
                        </div>
                    </div>
                </article>
            </section>
